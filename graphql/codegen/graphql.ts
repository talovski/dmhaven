...
export type SkillsQuery = { __typename?: 'Query', skills?: Array<{ __typename?: 'Skill', name: string, index: string, desc: Array<string>, ability_score: { __typename?: 'AbilityScore', desc: Array<string>, full_name: string, name: string, index: string } }> | null };
